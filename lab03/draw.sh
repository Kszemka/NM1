########################################## drawing script is a given resource
...
set style line 1 pt 5 ps 0.8 lc rgb "pink"               
set style line 2 pt 5 ps 0.8 lc rgb "blue" 
...
set ylabel "||r_k||_2" tc rgb "pink" offset 2, 0      # Podpis LEWEJ osi OY
...
set ytics tc rgb "pink"   # Kolor podpisow znacznikow LEWEJ osi OY
